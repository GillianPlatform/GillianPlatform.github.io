...
<!-- ::: info Note -->
<!-- *These lectures took place at the [Summer School on Security Testing and Verification](https://cybersecurity-research.be/summer-school-on-security-testing-and-verification-2026/) at [Vrije Universiteit Brussel](https://www.vub.be/en) in September 2026.* -->
<!-- ::: -->

## Lecture 1: Separation Logic and Compositional Symbolic Execution
- An introduction to Separation Logic, a modern Hoare logic
- Core Compositional Symbolic Execution
- A Gillian Taster

### Exercises
- [Simple assertions](/docs/standv26/assertions-answers.pdf)
...
## Lecture 2: Compositional Symbolic Execution and Gillian
